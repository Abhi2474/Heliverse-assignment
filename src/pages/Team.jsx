  ...
  return (
    ...
    <div className="grid grid-cols-3">
      {filteredData.map((user) => {
        return (
          <div key={user.id} className="w-80 h-72 bg-blue-100 py-6 pl-5 mx-auto my-4 rounded shadow-lg">
            <img
              src={user.avatar}
    ...
    : <h1 className="text-center text-5xl font-bold font-serif mt-20">Create Team First</h1>
    }
    </>
  );
};
